const config = {
  ...
  sidebar: {
    ...
    ignoreIndex: true,
    title:
      "hzuika <div class='greenCircle'></div> blog",
  },
  siteMetadata: {
    title: 'blog | hzuika',
